...
let s:last_modified = 'Sunday Mar 23 14:03:33 UTC 2023'
...
call everforest#highlight('NormalFloat', s:palette.grey1, s:palette.bg1)
call everforest#highlight('FloatBorder', s:palette.grey1, s:palette.bg1)
...
if has('nvim-0.9.0')
  ...
  highlight! link @lsp.type.struct TSStructure
...
call everforest#highlight('BufferLineCurrentTarget', s:palette.red, s:palette.none, 'bold')
call everforest#highlight('BufferLineErrorSelected', s:palette.red, s:palette.none, 'bold')
call everforest#highlight('BufferLineWarningDiagnosticSelected', s:palette.yellow, s:palette.none, 'bold')
call everforest#highlight('BufferLineWarningSelected', s:palette.yellow, s:palette.none, 'bold')
call everforest#highlight('BufferLineErrorDiagnosticSelected', s:palette.red, s:palette.none, 'bold')
call everforest#highlight('BufferLineHintDiagnosticSelected', s:palette.grey1, s:palette.none, 'bold')
call everforest#highlight('BufferLineInfoDiagnosticSelected', s:palette.blue, s:palette.none, 'bold')
call everforest#highlight('BufferLineInfoSelected', s:palette.blue, s:palette.none, 'bold')
call everforest#highlight('BufferLinePick', s:palette.red, ['#242a2f', '235'], 'italic')
call everforest#highlight('BufferLinePickSelected', s:palette.red, s:palette.none, 'italic')
call everforest#highlight('BufferLinePickVisible', s:palette.red, s:palette.none, 'italic')
...
call everforest#highlight('BufferLineModifiedVisible', s:palette.yellow, s:palette.bg2)
call everforest#highlight('BufferLineModified', s:palette.yellow, s:palette.bg2)
call everforest#highlight('BufferLineModifiedSelected', s:palette.yellow, s:palette.none)
...
call everforest#highlight('BufferLineInactiveModified', s:palette.grey1, s:palette.bg2)
...
call everforest#highlight('htmlLink', s:palette.blue, s:palette.none, 'underline')
