...
call everforest#highlight('BufferLineModifiedVisible', s:palette.blue, s:palette.bg2)
call everforest#highlight('BufferLineModified', s:palette.blue, s:palette.bg2)
